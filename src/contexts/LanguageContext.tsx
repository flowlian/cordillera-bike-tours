...
const translations = {
  de: {
    ...
    "about.text3": "Unsere Touren verbinden sportliche Herausforderungen mit kulturellen Erlebnissen. Du lernst nicht nur die Landschaft, sondern auch die herzlichen Menschen Kolumbiens kennen.",
    ...
    "about.smallGroupsDesc": "Maximal 8 Teilnehmer pro Tour für ein persönliches, familiäres Erlebnis.",
  ...
  en: {
    ...
    "about.text3": "Our tours combine athletic challenges with cultural experiences. You'll get to know not only the landscape but also the warm-hearted people of Colombia.",
    "about.safety": "Safety",
    ...
    "about.smallGroups": "Small Groups",
    "about.smallGroupsDesc": "Maximum 8 participants per tour for a personal, family-friendly experience.",
  ...
  es: {
    ...
    "about.text3": "Nuestros tours combinan desafíos deportivos con experiencias culturales. Conocerás no solo el paisaje, sino también a la gente cálida de Colombia.",
    ...
    "about.smallGroups": "Grupos Pequeños",
    "about.smallGroupsDesc": "Máximo 8 participantes por tour para una experiencia personal y familiar.",
